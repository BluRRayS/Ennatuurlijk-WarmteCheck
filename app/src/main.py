...
def calculate_heating_index(temperature_in_celsius: float) -> float:
    ...
    """
    return max(0.0, 20.0 - temperature_in_celsius)


def get_hourly_forecast_for_given_locations(
    weather_service: WeatherServiceInterface, locations: List[Location]
) -> Dict[str, Any]:
    ...
    for location in locations:
        ...
        forecast_data = weather_service.fetch_hourly_forecast(
        ...
        results.append({"place": location["name"], "forecast": hourly_heating_indices})
